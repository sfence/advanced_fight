...
local ent_name, ent_def = advanced_fight_lib.get_entity({"mobs_monster:stone_monster"})
	...
	head = {
		...
		effects = {
			["eye_hit"] = advanced_fight_lib.create_point_hit_effect({
				...
				texture_hit_point = "advanced_fight_stone_monster_hit_eye_%s.png",
...
if ent_def then
	local hitgroup_name = "mobs_monster:stone_monster"
