local ent_name, ent_def = advanced_fight_lib.get_entity({"mobs_monster:sand_monster"})

local parts = {
	head = {
		box = {x_min = -0.2, y_min = 0.45, z_min = -0.2,
					 x_max = 0.2, y_max = 0.85, z_max = 0.2},
		part_of_health = 0.8,
		...
		effects = {
			["eye_hit"] = advanced_fight_lib.create_point_hit_effect({
				...
				texture_hit_point = "advanced_fight_sand_monster_hit_eye_%s.png",
	...
	torso = {
		box = {x_min = -0.2, y_min = -0.2, z_min = -0.18,
					 x_max = 0.2, y_max = 0.45, z_max = 0.18},
		part_of_health = 1,
		damage_multiplier = 1,
		values = {},
	...
	hand_left = {
		box = {x_min = -0.32, y_min = -0.4, z_min = -0.08,
					 x_max = -0.2, y_max = 0.45, z_max = 0.08},
		part_of_health = 0.4,
	...
	hand_right = {
		box = {x_min = 0.2, y_min = -0.4, z_min = -0.08,
					 x_max = 0.32, y_max = 0.45, z_max = 0.08},
		part_of_health = 0.4,
		damage_multiplier = 0.5,
		miss_chance = 0.5,
		miss_chance_angles = {
	...
	leg_left = {
		box = {x_min = -0.2, y_min = -1, z_min = -0.08,
					 x_max = -0.05, y_max = -0.2, z_max = 0.08},
		part_of_health = 0.35,
	...
	leg_right = {
		box = {x_min = 0.05, y_min = -1, z_min = -0.08,
					 x_max = 0.2, y_max = -0.2, z_max = 0.08},
		part_of_health = 0.35,
		damage_multiplier = 0.7,
		miss_chance = 0.4,
		miss_chance_angles = {
...
local parts_attack = {
	hand_left = {
		box = {x_min = -0.32, y_min = 0.35, z_min = -0.08,
					 x_max = -0.2, y_max = 0.6, z_max = 0.65},
	},
	hand_right = {
		box = {x_min = 0.2, y_min = 0.35, z_min = -0.08,
					 x_max = 0.32, y_max = 0.6, z_max = 0.65},
	}
}

if ent_def then
	local hitgroup_name = "mobs_monster:sand_monster"
	...
	ent_def.attack_offsets = {
		punch_offset = vector.new(0, 0.6, 0),
